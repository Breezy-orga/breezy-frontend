...
const handleLike = async (postId: string) => {
  ...
  return (
    <div className="flex flex-col w-full max-w-2xl mx-auto p-4">
      ...
      {users.length > 0 && (
        <div className="mt-6">
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">{t("search.users")}</h2>
      ...
      {posts.length > 0 && (
        <div className="mt-6">
          <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">{t("search.posts")}</h2>
          <div className="space-y-4">
            {posts.map((post) => (
              <Post 
                key={post._id} 
